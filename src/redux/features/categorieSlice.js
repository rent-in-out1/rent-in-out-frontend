...
export const addCategory = createAsyncThunk('addCategory/add', async (addData) => {
	try {
		let url = '/categories';
...
export const deleteCategory = createAsyncThunk('deleteCategory/delete', async ({ id, name }) => {
	try {
...
export const editCategory = createAsyncThunk('editCategory/edit', async ({ id, editData, setOnEdit }) => {
	const url = `/categories/${id}`;
...
export const getCatgories = createAsyncThunk('categories/get', async ({ search, option, page }) => {
	try {
