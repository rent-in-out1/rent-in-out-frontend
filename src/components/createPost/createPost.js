...
return;
  ...
  return (
    ...
    <div className='mx-auto w-1/2 p-4 shadow'>
        <h2 className="mx-3 text-md">Create your next post!</h2>
        <div className='flex p-2 items-center space-x-1 mx-2'>
            <div>
        ...
        <div className="w-full md:w-1/2 px-3 mt-2">
                        ...
                        <div className="w-full md:w-1/2 px-3 mt-2">
                            ...
                            <input 
                                ...
                                type="text" placeholder=' give short info ..'
                            />
                            {errors.info && errorHandler("Enter valid info.")}
                        </div>
                        <div className="w-full md:w-1/2 px-3 mt-2">
                            ...
                            />
                            {errors.category && errorHandler("Enter valid category.")}
                        </div>
                        <div className="w-full  -mx-1.8 px-3">
          
            <select
              ref={rangRef}
              defaultValue={selecterange}
              onChange={() => setSelecterange(rangRef.current.value)}
              className="w-full md:w-1/3"
            >
              <option value="short-term" key={0} className="text-sm font-medium">
              short-term
              </option>
              <option value="long-term" key={0}  className="text-sm font-medium">
              long-term
              </option>
     ...
     <div>   
    <textarea className='w-full md:w-3/4 mx-3 mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600'  rows={4} {...register("textarea", {
      required: true,
      minLength:6,
      maxLength:50, 
...
<div className="mx-2">
<button type="submit" className=" mx-1 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-purple-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
       Publish post
   </button>
   <button type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-purple-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
      Discard
   </button>
</div>
        </form>
