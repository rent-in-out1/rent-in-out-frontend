...
export const Details = () => {
  ...
  return (
    ...
    <h2>Edit category</h2>
    {user.fullName.firstName ? <form onSubmit={handleSubmit(onSubForm)} className='col-md-6 p-3 shadow'>
      <label>Name:</label>
      ...
      <div className='mt-3'>
        <button className='btn btn-success me-5' onClick={dispath}>Update</button>
