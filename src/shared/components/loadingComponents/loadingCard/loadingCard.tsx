interface ILoadingCardPropsModel {
	cardsNumber: number;
}

const LoadingCard = ({ cardsNumber }: ILoadingCardPropsModel) => {
	return Array(cardsNumber)
		.fill(0)
		.map((_, i) => (
			<div role='status' className='p-4 border border-gray-200 rounded shadow animate-pulse md:p-6' key={i}>
