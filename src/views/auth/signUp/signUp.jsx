...
import { getCities, getCountries } from '../../../api/services/get-locations-service/get-locations-service';
				...
				<div className='filters w-full flex mr-2'>
					...
					<div className='w-4/5 mr-1'>
						...
						<select
							...
							className='block py-2.5 px-2 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-nonefocus:outline-none focus:ring-0 focus:border-gray-200 peer'
						>
							{cities?.map((city, i) => (
